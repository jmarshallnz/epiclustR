...
plot_spatial(cau$mod, cau$data, period=1, legend=FALSE, threshold=0.2,
             ...
             shapefile='../shape_files/midcentral_phu')
...
plot_region(ta$mod, ta$data, region = 2, main = "Palmerston North city")
plot_region(ta$mod, ta$data, region = 3, main = "Tararua District")
```
