...
We see that there are potential outbreaks in Highbury, Ashhurst and Waiopehu, and multiple potential outbreaks in Levin and Pahiatua. The outbreak series for these regions are below.

```{r cau_outbreaks, fig.width = 6, fig.height = 8}
par(mfrow=c(5,1), mar = c(3,3,2,2))
plot_region(cau$mod, cau$data, region = "Highbury")
plot_region(cau$mod, cau$data, region = "Ashhurst")
plot_region(cau$mod, cau$data, region = "Waiopehu")
plot_region(cau$mod, cau$data, region = "Levin East")
plot_region(cau$mod, cau$data, region = "Pahiatua")
```
